    ...
    <div className="container">
      <form onSubmit={handleSubmit}>
        <div className="form-group row">
          <label className="col-sm-2 col-form-label offset-sm-1" htmlFor="name">
            Course Name:{" "}
          </label>
        ...
        <div className="form-group my-3 row">
          <label
            htmlFor="description"
            className="my-3 col-sm-2 col-form-label offset-sm-1"
          >
            Course description
          </label>
          <div className="col-sm-6">
        ...
        <div className="form-group row my-3">
          <label
            className="col-sm-2 col-form-label offset-sm-1"
            htmlFor="description"
          >
            Level:{" "}
          </label>
        ...
        <div className="my-3 form-group row">
          <label htmlFor="formImage" className="form-label col-2 offset-sm-1">
            Course Preview Image
          </label>
          <div className="col-5">
            <input
              className={`form-control ${fileImageError ? "is-invalid" : ""}`}
              type="file"
              id="formImage"
        ...
        <div className="my-3 form-group row">
          <label htmlFor="formVideo" className="form-label col-2 offset-sm-1">
            Course Preview Video
          </label>
          <div className="col-5">
            <input
              className={`form-control ${fileVideoError ? "is-invalid" : ""}`}
              type="file"
              id="formVideo"
